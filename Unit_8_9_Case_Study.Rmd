...
maxdf$State[which.max(maxdf$ABV)]
maxdf$State[which.max(maxdf$IBU)]
```
Nevada state has the maximum alcoholic (ABV) beer while West Virginia state has the most bitter beers. 
